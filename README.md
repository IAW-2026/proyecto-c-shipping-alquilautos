...
## Tener en cuenta para utilizar la aplicacion:
    ...
    - El usuario para utilizar la app debe ser el otorgado, que tiene role = "admin"; de lo contrario se solicitará ingresar con un
     usuario que cuente con los permisos necesarios.
